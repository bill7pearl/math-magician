...
<div align="center">
  ...
  <img src="UImath-magician.png" alt="logo" width="700"  height="auto" />
  <br/>

  <h3><b>Math-magician UI Sample</b></h3>
...
> This is the 1st React project in my Microverse curriculum.
> **Math-magician** is a React application calculator app.
...
- **User can do basic arithmetic operations**
...
```sh
git clone https://github.com/bill7pearl/math-magician.git
```
